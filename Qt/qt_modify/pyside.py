...
pyside_modifier = QtModifier()


@pyside_modifier.register("clib.wrapinstance")
def wrapinstance(*args, **kwargs):

    try:
        import shiboken
    except ImportError:
        raise RuntimeError("This method isn't executable without shiboken module.")

    return shiboken.wrapInstance(*args, **kwargs)


@pyside_modifier.register("clib.unwrapinstance")
...
_cls_cache = {}
@pyside_modifier.register("uic.loadUiType")
def loadUiType(uifile):
    ...
    try:
        ...
        raise RuntimeError("This method isn't executable without pysideuic module.")
...
ori_event_init = QtCore.QEvent.__init__
@pyside_modifier.register("QtCore.QEvent.__init__")
def event_init(self, event):
    ori_event_init(self, QtCore.QEvent.Type(event))


@pyside_modifier.register("QtWidgets.QTreeWidgetItem.setBackgroundColor")
def setBackgroundColor(self, p_int, QColor):
    QtGui.QTreeWidgetItem.setBackground(self, p_int, QColor)


@pyside_modifier.register("QtWidgets.QTreeWidgetItem.setTextColor")
...
@pyside_modifier.register("uic.loadUi")
...
ori_set_focus_policy = QtGui.QWidget.setFocusPolicy
@pyside_modifier.register("QtGui.QWidget.setFocusPolicy")
def setFocusPolicy(self, focus_policy):
    ori_set_focus_policy(self, QtCore.Qt.FocusPolicy(focus_policy))
