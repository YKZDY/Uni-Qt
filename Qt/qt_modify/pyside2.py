...
pyside2_modifier = QtModifier()


@pyside2_modifier.register("clib.wrapinstance")
def wrapinstance(*args, **kwargs):

    try:
        import shiboken2
    except ImportError:
        raise RuntimeError("This method isn't executable without shiboken2 module.")

    return shiboken2.wrapInstance(*args, **kwargs)


@pyside2_modifier.register("clib.unwrapinstance")
...
_cls_cache = {}
@pyside2_modifier.register("uic.loadUiType")
...
@pyside2_modifier.register("uic.loadUi")
...
ori_set_focus_policy = QtWidgets.QWidget.setFocusPolicy
@pyside2_modifier.register("QtWidgets.QWidget.setFocusPolicy")
